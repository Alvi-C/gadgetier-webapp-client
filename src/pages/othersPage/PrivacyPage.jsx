			...
			<section className='px-4 py-24 mx-auto max-w-7xl'>
				...
				<div className='mx-auto prose'>
					...
					<p>
						...
						misappropriates any persons copyright, patent, trademark, or trade
					...
					<p>
						...
						of harmful computer code, nor subject the Websites network or
					...
					<p>
						If you work for a company or at a University, its likely that
						youre not the copyright holder of anything you make, even in your
					...
					<p>
						...
						Operatorss current Privacy Policy and the stated license of this
						website.
					</p>
					...
					<p>
						THE OPERATORSS TOTAL CUMULATIVE LIABILITY FOR ANY AND ALL CLAIMS IN
					...
					<p>
						...
						partys principal place of business, attention of that partys
						...
						Agreement or Users use of the Website must be brought in the courts
